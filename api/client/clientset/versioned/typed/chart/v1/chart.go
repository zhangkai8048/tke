...
func newCharts(c *ChartV1Client, namespace string) *charts {
	return &charts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *charts) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Chart, err error) {
	result = &v1.Chart{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ChartList, err error) {
...
func (c *charts) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *charts) Create(ctx context.Context, chart *v1.Chart, opts metav1.CreateOptions) (result *v1.Chart, err error) {
	result = &v1.Chart{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) Update(ctx context.Context, chart *v1.Chart, opts metav1.UpdateOptions) (result *v1.Chart, err error) {
	result = &v1.Chart{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) UpdateStatus(ctx context.Context, chart *v1.Chart, opts metav1.UpdateOptions) (result *v1.Chart, err error) {
	result = &v1.Chart{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *charts) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *charts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Chart, err error) {
	result = &v1.Chart{}
