...
type Interface interface {
	...
	// ChartGroupLists returns a ChartGroupListInformer.
	ChartGroupLists() ChartGroupListInformer
...
// ChartGroupLists returns a ChartGroupListInformer.
func (v *version) ChartGroupLists() ChartGroupListInformer {
	return &chartGroupListInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
