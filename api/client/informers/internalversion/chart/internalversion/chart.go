	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Chart().Charts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Chart().Charts(namespace).Watch(context.TODO(), options)
			},
		},
		&chart.Chart{},
		resyncPeriod,
...
func (f *chartInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&chart.Chart{}, f.defaultInformer)
}
