	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ChartV1().Charts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ChartV1().Charts(namespace).Watch(context.TODO(), options)
			},
		},
		&chartv1.Chart{},
		resyncPeriod,
...
func (f *chartInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&chartv1.Chart{}, f.defaultInformer)
}
