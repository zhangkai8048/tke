...
func (c *Controller) watchChartGroupHealth(ctx context.Context, key string) func() (bool, error) {
	return func() (bool, error) {
		...
		chartGroup, err := c.client.ChartV1().ChartGroups().Get(ctx, chartGroupName, metav1.GetOptions{})
		...
		if chartGroup.Status.Phase == chartv1.ChartGroupTerminating || chartGroup.Status.Phase == chartv1.ChartGroupPending {
...
func (c *Controller) checkChartGroupHealth(ctx context.Context, chartGroup *chartv1.ChartGroup) error {
	...
	for _, p := range chartGroup.Spec.Projects {
		...
		case chartv1.ChartGroupAvailable:
			if err != nil {
				...
				//
				// chartGroup.Status.Phase = chartv1.ChartGroupFailed
