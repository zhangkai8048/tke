...
func NewChartGroupResourcesDeleter(businessClient businessversionedclient.BusinessV1Interface,
	registryClient v1clientset.ChartV1Interface, finalizerToken chartv1.FinalizerName,
...
type chartGroupResourcesDeleter struct {
	...
	registryClient v1clientset.ChartV1Interface
	...
	finalizerToken chartv1.FinalizerName
...
func (d *chartGroupResourcesDeleter) deleteChartGroup(ctx context.Context, chartGroup *chartv1.ChartGroup) error {
...
type updateChartGroupFunc func(ctx context.Context, chartGroup *chartv1.ChartGroup) (*chartv1.ChartGroup, error)

// retryOnConflictError retries the specified fn if there was a conflict error
// it will return an error if the UID for an object changes across retry operations.
// TODO RetryOnConflict should be a generic concept in businessClient code
func (d *chartGroupResourcesDeleter) retryOnConflictError(ctx context.Context, chartGroup *chartv1.ChartGroup, fn updateChartGroupFunc) (result *chartv1.ChartGroup, err error) {
...
func (d *chartGroupResourcesDeleter) updateChartGroupStatusFunc(ctx context.Context, chartGroup *chartv1.ChartGroup) (*chartv1.ChartGroup, error) {
	if chartGroup.DeletionTimestamp.IsZero() || chartGroup.Status.Phase == chartv1.ChartGroupTerminating {
		return chartGroup, nil
	}
	newChartGroup := chartv1.ChartGroup{}
	newChartGroup.ObjectMeta = chartGroup.ObjectMeta
	newChartGroup.Status = chartGroup.Status
	newChartGroup.Status.Phase = chartv1.ChartGroupTerminating
...
func finalized(chartGroup *chartv1.ChartGroup) bool {
...
func (d *chartGroupResourcesDeleter) finalizeChartGroup(ctx context.Context, chartGroup *chartv1.ChartGroup) (*chartv1.ChartGroup, error) {
	chartGroupFinalize := chartv1.ChartGroup{}
	...
	chartGroupFinalize.Spec.Finalizers = make([]chartv1.FinalizerName, 0, len(finalizerSet))
	for _, value := range finalizerSet.List() {
		chartGroupFinalize.Spec.Finalizers = append(chartGroupFinalize.Spec.Finalizers, chartv1.FinalizerName(value))
	}
	chartGroup = &chartv1.ChartGroup{}
	var err error
...
type deleteResourceFunc func(ctx context.Context, deleter *chartGroupResourcesDeleter, chartGroup *chartv1.ChartGroup) error
...
func (d *chartGroupResourcesDeleter) deleteAllContent(ctx context.Context, chartGroup *chartv1.ChartGroup) error {
...
func deleteChartGroup(ctx context.Context, deleter *chartGroupResourcesDeleter, chartGroup *chartv1.ChartGroup) error {
...
func deleteChart(ctx context.Context, deleter *chartGroupResourcesDeleter, chartGroup *chartv1.ChartGroup) error {
	var errs []error
