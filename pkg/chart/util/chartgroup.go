...
import (
	...
	registryapi "tkestack.io/tke/api/chart"
	chartinternalclient "tkestack.io/tke/api/client/clientset/internalversion/typed/chart/internalversion"
...
func ListUserChartGroups(ctx context.Context,
	options *metainternal.ListOptions,
	businessClient businessversionedclient.BusinessV1Interface,
	chartClient *chartinternalclient.ChartClient,
	...
	namespace := ""
	cgList, err := chartClient.ChartGroups(namespace).List(ctx, metav1.ListOptions{
