...
const (
	flagChartConfig   = "chart-config"
	configChartConfig = "chart_config"
)

// Options is the main context object for the TKE registry apiserver.
type Options struct {
	Log            *log.Options
...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	_ = viper.BindPFlag(configChartConfig, fs.Lookup(flagChartConfig))
}
...
// Should be called after tke-registry-api flags parsed.
