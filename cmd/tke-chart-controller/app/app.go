...
import (
	...
	"tkestack.io/tke/cmd/tke-chart-controller/app/config"
	"tkestack.io/tke/cmd/tke-chart-controller/app/options"
	"tkestack.io/tke/pkg/app"
	"tkestack.io/tke/pkg/util/log"
)

const commandDesc = `The chart controller manager is a daemon that embeds the core control loops. In 
 ...
 loop that watches the shared state of the image namespace and chartgroup through the 
